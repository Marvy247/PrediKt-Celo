...
export default function BattleDetail() {
  ...
  const ensureBaseNetwork = async () => {
    if (chain?.id !== CELO_MAINNET_CHAIN_ID) {
          ...
          <CardContent className="pt-6 space-y-6">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="p-4 rounded-lg bg-muted/50 text-center">
                ...
                <p className="text-lg font-bold text-gray-900 dark:text-gray-100">{formatEther(battle.stakeAmount)} CELO</p>
              </div>
              
              <div className="p-4 rounded-lg bg-muted/50 text-center">
                <Trophy className="h-6 w-6 text-yellow-500 mx-auto mb-2" />
                <p className="text-sm font-semibold text-gray-700 dark:text-gray-300">Winner Gets</p>
                <p className="text-lg font-bold text-gray-900 dark:text-gray-100">{formatEther(battle.stakeAmount * BigInt(2) * BigInt(975) / BigInt(1000))} CELO</p>
              </div>
        ...
        {canAccept && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Stake {formatEther(battle.stakeAmount)} CELO to accept this challenge
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button
              ...
              >
                ...
                {isSwitchingChain ? "Switching Network..." : isPending ? "Accepting..." : `Accept Battle (${formatEther(battle.stakeAmount)} CELO)`}
              </Button>
            </CardContent>
          </Card>
        )}
